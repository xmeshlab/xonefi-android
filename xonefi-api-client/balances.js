  ...
  bnetwork.get_bnetwork_db((net) => {
    ...
    if (config_json.account_set) {
      var myContract = new web3.eth.Contract(
        contract_config_json.contract_abi,
        contract_config_json.smart_contract
      );
      myContract.methods
        .balanceOf(config_json.account.address)
        .call({ from: config_json.account.address }, function (error, result) {
