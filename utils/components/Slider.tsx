...
export const Slider = ({value, maxiumValue, ...viewProps}: SliderProps & ViewProps) => {
    ...
    return (<View {...viewProps} ref={mainRef} style={viewProps.style}>
            ...
            <View style={[style.sliderProgress, {width: progressWidth}]}>
                ...
                <View style={{flex: 1, position: 'relative'}} >
                    ...
                    <View  style={[style.tooltip, {
                        ...
                        <Text numberOfLines={1} style={style.tooltipText}>{percent}%</Text>
                    </View>
                </View>
...
const style = StyleSheet.create({
    sliderBg: {
        marginTop: 9, // flex: 1,
        height: 4, width: '100%', borderRadius: 2, backgroundColor: 'black', position: 'relative',
    }, sliderProgress: {
        height: 4, borderRadius: 40, backgroundColor: '#2B3FF2', position: 'relative'
    }, slideCircle: {
        position: 'absolute',
        right: -8,
        top: -6,
        ...
        fontSize: 12, fontWeight: '400', fontStyle: 'normal', lineHeight: 12, color: '#9FAEC3'
