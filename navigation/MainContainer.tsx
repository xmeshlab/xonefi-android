...
import { DefaultNavigatorOptions, RouteConfig } from '@react-navigation/core/lib/typescript/src/types';
import ConnectStatusScreen from './screens/ConnectStatusScreen';
import { WithMainBg } from '../utils/components/WithMainBg';
import { StatusBar } from 'expo-status-bar';
import  { TabPageHeader, WithBackBtnPageHeader } from '../utils/components/PageHeader';
...
type RootStackParamList = {
    Connect: undefined;
    Status: undefined,
    Account: undefined; Provider: undefined; Wallet: undefined; Home: undefined;
...
export type GlobalRoute = {
    ...
    ['Linked Payment Card']: undefined, ['Create New Account']: undefined,
...
const tabOptions = {tabBarLabel: () => null, header: (props) => <TabPageHeader {...props}/>};
...
function HomeTab() {
    ...
    const tabNavigatorScreenOptions: DefaultNavigatorOptions<any, any, any, any>['screenOptions'] = useCallback(({route}) => {
        return ({
            tabBarIcon: (param) => {
    ...
    const tabScreenComponent = useCallback(() => <View><Text>home</Text></View>, [])
    ...
    return (
        ...
        <TabNavigator
            ...
            <TabScreen options={{...tabOptions, title: connectName}} name={connectName} component={ConnectScreen}/>
            <TabScreen name={StatusName} component={ConnectStatusScreen} options={{...tabOptions, title: StatusName}}/>
            {/*<TabScreen name={providerName} component={ProviderScreen} options={{...tabOptions, title: providerName}}/>*/}
            <TabScreen options={{...tabOptions, title: homeName}} name={homeName}
                       component={tabScreenComponent}/>
            <TabScreen options={{...tabOptions, title: cardName}} name={cardName} component={WalletScreen}/>
            <TabScreen name={linkedAccountName} component={LinkedAccountScreen}
...
const stackNavigatorScreenOptions: DefaultNavigatorOptions<GlobalRoute, any, any, any>['screenOptions'] = {
...
export default function MainContainer() {
    ...
    return <WithMainBg style={{flex: 1}}>
            <StatusBar style="light"/>
            <NavigationContainer theme={MyTheme}>
                <Stack.Navigator
                    initialRouteName={'HomeTab'}
                >
                    <Stack.Screen options={{header: () => null}} name={'HomeTab'} component={HomeTab}/>
                    <Stack.Screen options={{...stackNavigatorScreenOptions, title: 'Connect'}}
                                  name={'PayAndConnect'}
                                  component={PayAndConnectScreen}/>
                    <Stack.Screen options={{...stackNavigatorScreenOptions, title: 'ConnectStatus'}}
                                  name={'ConnectStatus'}
                                  component={ConnectStatusScreen}/>
                    <Stack.Screen options={{...stackNavigatorScreenOptions, title: 'Provider'}} name="Provider"
                                  component={ProviderScreen}/>
                    <Stack.Screen options={{...stackNavigatorScreenOptions, title: 'ProviderDetails'}}
                                  name="ProviderDetails"
                                  component={ProviderDetailScreen}/>
                    <Stack.Screen options={{...stackNavigatorScreenOptions, title: 'Account'}} name="Account"
                                  component={LinkedAccountScreen}/>
                    <Stack.Screen name="Linked Payment Card"
                                  options={{...stackNavigatorScreenOptions, title: 'Linked Payment Card'}}
                                  component={LinkedPaymentCardScreen}/>
                    <Stack.Screen name="Account Information" options={{...stackNavigatorScreenOptions,title: 'Account Information'}}
