...
export default function LinkedAccountScreen({navigation}) {
    const onTouchableOpacityPress = useCallback(() => navigation.navigate('Account Information'), [])

    return(
        //<View className="flex-1 flex-col bg-black pt-5">
        <View className="flex-1 flex-col pt-5" style={{backgroundColor: 'rgba(0,0,0,0.0)'}} >
            <TouchableOpacity onPress={()=> navigation.navigate('Linked Payment Card')}
