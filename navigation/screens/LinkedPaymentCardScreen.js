...
export default function LinkedPaymentCardScreen({navigation}) {
    return(
        <ImageBackground source={backgroundImage} resizeMode="cover" className="flex-1 flex-col">
            <Text className="text-white text-xl mt-6 mb-1 mx-6">Add New Payment Card</Text>
            ...
            <View className="flex flex-col ml-5 mr-5 bg-slate-800 bg-rounded p-2 rounded-2xl justify-around">
                <View className="flex flex-row  justify-between">
                    <View className="pl-3 pr-3">
                        <TextInput selectionColor="#FFF" placeholderTextColor="#FFF" placeholder="John Doe"/>
                    </View>
                </View>
            </View>
            ...
            <ImageBackground className="mt-8 p-1 flex flex-row justify-center" source={buttonBackground} resizeMode="contain">
