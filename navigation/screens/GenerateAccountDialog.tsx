    ...
    <>
      <ScrollView className="flex-1 flex-col">
        <Text className="text-white text-3xl mt-6 mb-2 mx-6">
          Generating a new crypto account.
        </Text>
        <Text className="text-white text-l mb-2 mx-6 mt-2">
          To make account secure, we need a good random seed. For that, please
          type random letters, numbers or punctuation in the field below. You
          can type as many random symbols as you want, but not less than 16.{" "}
        </Text>
        <GreyTextInputBar
          placeholder_text={"Enter Random Seed"}
          state_function={setAccountName}
        />
        <Text className="text-white text-l mb-2 mx-6 mt-2">
          Please create a good secret password that will be used to encrypt the
          private key stored at this computer. The password must be at least 8
          symbols long. Please note that this password is used only locally, and
          it is not your account password.{" "}
        </Text>
        <GreyTextInputBar
          placeholder_text={"Enter Secret Password"}
          state_function={setPassword}
        />
        <BigBlueButton
