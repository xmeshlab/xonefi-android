...
export default function WalletScreen({navigation}) {
    ...
    useEffect(()=>{
      let interval = setInterval(() => {
        fetch("https://api.coingecko.com/api/v3/simple/price?ids=bitcoin%2Cethereum%2Cbinancecoin%2Csolana%2Cmatic-network&vs_currencies=usd")
    ...
    <View className="flex-1">
        <React.Fragment> 
                ...
                <ScrollView style={{backgroundColor: 'transparent'}}>
                  ...
                  <Asset AssetName="Solana Wallet" AssetAmount="4.5 SOL" AssetPrice={"$" + priceJson.solana.usd} AssetLogo={() => <SolanaLogoSVG/>} AssetChange="0.56%"/>
                  <Asset AssetName="Matic Wallet" AssetAmount="3.6 MATIC" AssetPrice={"$" + priceJson["matic-network"].usd} AssetLogo={() => <MaticLogoSVG/>} AssetChange="0.56%"/>
                </ScrollView>
        </React.Fragment>
    </View>
);
