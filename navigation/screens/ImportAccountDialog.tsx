      ...
      <View className="flex-1 flex-col">
        <ScrollView>
          ...
          <Text className="text-white text-l mb-2 mx-6 mt-2">
            Please enter your existing account's private key below
          </Text>
          <GreyTextInputBar
            placeholder_text={"Enter Private Key"}
            state_function={setPrivateKey}
          />
          <Text className="text-white text-l mb-2 mx-6 mt-2">
            Please create a good secret password that will be used to encrypt
            the private key stored at this computer. The password must be at
            least 8 symbols long. Please note that this password is used only
            locally, and it is not your account password.{" "}
          </Text>
          <GreyTextInputBar
          ...
          <GreyTextInputBar
            placeholder_text={"Enter Secret Password"}
            state_function={setPassword2}
          />
          <BigBlueButton
            text={"Import Account"}
            onPressFunction={importAccount}
          />
          <BlurModal
