...
<View>
      ...
      <GreyTextInputBar placeholder_text={"Enter Full Name"} state_function={setCardHolder}/>

      <Text className="pl-8 text-slate-400 text-base mt-2">Card Number</Text>
      <GreyTextInputBar placeholder_text={"Enter Card Number"} state_function={setCardNumber}/>
      

      <View className="flex flex-row">
        <View className="flex flex-col w-6/12">
          <Text className="pl-8 text-slate-400 text-base mt-2">CSV</Text>
          <GreyTextInputBar placeholder_text={"Enter CSV"} state_function={setCardCSV}/>
        </View>

        <View className="flex flex-col w-6/12">
          <Text className="pl-8 text-slate-400 text-base mt-2">EXP</Text>
          <GreyTextInputBar placeholder_text={"Enter EXP"} state_function={setCardEXP}/>
      </View>
      </View>
      <View className="mt-3">
        <BigBlueButton
