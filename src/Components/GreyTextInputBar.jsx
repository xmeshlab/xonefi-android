...
/**
 * Grey Text Input Bar just without the margins. Useful for when used inside a GreyBackgroundBox component
 */
export function GreyTextInputBarNoMargin({ placeholder_text, state_function }) {
  const onTextInputChangeText = useCallback((text) => {
    state_function(text);
  }, []);
