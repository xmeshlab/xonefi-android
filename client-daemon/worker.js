...
function client_worker(config_json, user_password, private_key, callback) {
    ...
    console.log(`XLOG: @DEB5 config_json.client_session.initiated_sack_number: ${config_json.client_session.initiated_sack_number}`);
    console.log(`XLOG: @DEB5 config_json.client_session.sack_number: ${config_json.client_session.sack_number}`);
